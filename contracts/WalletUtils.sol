...
contract TokenBalanceChecker {
    ...
    function getTokenDetails(address tokenContractAddress) public view returns (
        string memory name,
        ...
        uint256 totalSupplyUint = _callUint256Function(tokenContractAddress, "totalSupply()");
        totalSupply = totalSupplyUint.toString();
    }

    function _callStringFunction(address contractAddress, string memory functionSignature) internal view returns (string memory) {
        (bool success, bytes memory data) = contractAddress.staticcall(abi.encodeWithSignature(functionSignature));
        require(success, "Function call failed");
        return abi.decode(data, (string));
    }

    function _callUint8Function(address contractAddress, string memory functionSignature) internal view returns (uint8) {
        (bool success, bytes memory data) = contractAddress.staticcall(abi.encodeWithSignature(functionSignature));
        require(success, "Function call failed");
        return abi.decode(data, (uint8));
    }

    function _callUint256Function(address contractAddress, string memory functionSignature) internal view returns (uint256) {
        (bool success, bytes memory data) = contractAddress.staticcall(abi.encodeWithSignature(functionSignature));
        require(success, "Function call failed");
        return abi.decode(data, (uint256));
    }
